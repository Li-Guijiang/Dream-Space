...
> Eternally evolving digital realm, embracing every youthful dream and tender reverie through innovation.

**きらめく — 像星光一样闪烁**

一个二次元风格的全栈创意社区 / 全栈博客系统（基于个人领导全栈开发），前端 Next.js，后端 FastAPI，附带 Vue 管理后台。
